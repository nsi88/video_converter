...
module VideoConverter
  class Output
    ...
    attr_accessor :chunks_dir, :crop, :drm, :faststart, :ffmpeg_output, :filename, :group, :height, :log, :no_fragments, :one_pass, :options, :path, :rotate, :streams, :thumbnails, :type, :uid, :watermarks, :width, :work_dir
    ...
    def initialize params = {}
      ...
      [:path, :streams, :width, :height, :one_pass, :rotate, :faststart, :thumbnails, :group, :drm, :no_fragments, :crop, :watermarks].each { |attr| self.send("#{attr}=", params[attr]) }
